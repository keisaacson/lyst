...
describe ListsController do
  ...
  let(:valid_attributes) { { "list_type" => "MyString" } }
  ...
  describe "GET index" do
    xit "assigns all lists as @lists" do
  ...
  describe "GET show" do
    xit "assigns the requested list as @list" do
      list = List.create! valid_attributes
  ...
  describe "GET new" do
    xit "assigns a new list as @list" do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      xit "assigns a newly created list as @list" do
        post :create, {:list => valid_attributes}, valid_session
        assigns(:list).should be_a(List)
        assigns(:list).should be_persisted
      end

      xit "redirects to the created list" do
        post :create, {:list => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      xit "assigns a newly created but unsaved list as @list" do
        # Trigger the behavior that occurs when invalid params are submitted
        List.any_instance.stub(:save).and_return(false)
        post :create, {:list => { "list_type" => "invalid value" }}, valid_session
        assigns(:list).should be_a_new(List)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      xit "updates the requested list" do
        list = List.create! valid_attributes
        ...
        List.any_instance.should_receive(:update).with({ "list_type" => "MyString" })
        put :update, {:id => list.to_param, :list => { "list_type" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      xit "assigns the list as @list" do
        list = List.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        List.any_instance.stub(:save).and_return(false)
        put :update, {:id => list.to_param, :list => { "list_type" => "invalid value" }}, valid_session
        assigns(:list).should eq(list)
      end
  ...
  describe "DELETE destroy" do
    xit "destroys the requested list" do
      list = List.create! valid_attributes
      expect {
    ...
    xit "redirects to the lists list" do
      list = List.create! valid_attributes
      delete :destroy, {:id => list.to_param}, valid_session
